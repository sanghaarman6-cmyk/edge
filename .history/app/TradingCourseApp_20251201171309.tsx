...
const [lotPersonalLeverageInput, setLotPersonalLeverageInput] = useState<string>('500');
  ...
  const handleLotCalculate = () => {
    ...
    if (cfg.type === 'forex') {
      contractValuePerLot = cfg.pipValuePerLot * 13500; // e.g. 10 × 10k = 100k notional
    } else {
      contractValuePerLot = cfg.pipValuePerLot * 100; // index/gold/crypto approx
    }
  ...
  if (!authenticated)
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-black text-white">
        <h2 className="text-2xl font-semibold mb-3">Enter Course Password</h2>
        <input
          type="password"
          value={password}
          ...
          className="bg-zinc-900 border border-zinc-700 rounded px-4 py-2 mb-3 outline-none"
        />
