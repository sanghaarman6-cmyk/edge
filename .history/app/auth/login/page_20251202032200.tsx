...
export default function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-black text-white">
      <div className="mb-6 p-3 bg-yellow-500/10 border border-yellow-600/40 text-yellow-400 rounded-md text-sm">
        ⚠️ For the best experience, please use this course on a desktop or laptop computer.
      </div>
