  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center px-4" onContextMenu={(e) => e.preventDefault()}>
        ...
        <section className="w-full max-w-4xl text-center">
          ...
          >
            A MECHANICAL TRADING SYSTEM BUILT FOR CONSISTENCY
          </motion.h1>
          ...
          <div className="mt-6 flex items-center gap-4 justify-center">
            ...
            >
              I spent years stripping trading down to what actually matters:
              rules, structure, and risk.
                <br />
              This free training breaks down a fully mechanical trading system
              designed to remove emotion, overthinking, and inconsistency —
              so every trade is executed the same way, every time.
      ...
      <section className="w-full max-w-5xl mt-10">
        ...
        <div className="bg-zinc-950 border border-black-800 rounded-2xl overflow-hidden">
          <img
