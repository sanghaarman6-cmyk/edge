      ...
      <section className="w-full max-w-4xl">
        <div className="rounded-xl overflow-hidden bg-black relative">
          ...
          >
            ...
            >
              {/* FULL TRAINING VIDEO */}
              <div className="wistia_embed wistia_async_hul95wbvt3 videoFoam=true"></div>
            </div>
          </div>
{/* FULL TRAINING VIDEO */}
    ...
    ">
      ...
      <div className="text-center sm:text-left">
        ...
        <p className="mt-1 text-sm text-zinc-400">
          Complete system • Real execution logic • Full mentor style access
        </p>
      </div>

      {/* CTA BUTTON */}
      <a
        href="https://www.skool.com/prop-accelerator-8039/about"
        target="_blank"
