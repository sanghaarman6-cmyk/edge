...
<div className="fixed bottom-4 inset-x-0 z-40 flex justify-center pointer-events-none">
  ...
  >
    <Button
      ...
      className="px-6 py-4 bg-green-400 hover:bg-green-300 text-black font-semibold rounded-2xl shadow-xl"
    >
      <div className="flex flex-col items-center leading-tight">
        <span className="text-base sm:text-lg">Unlock Free Training</span>
        <span className="text-xs opacity-80">(limited spots)</span>
      </div>
    </Button>
  </motion.div>
</div>
