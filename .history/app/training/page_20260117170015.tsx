...
export default function TrainingLandingPage() {
  ...
  const [open, setOpen] = useState(false);
    ...
    {
      thumb: '/yt/vid1.jpg',
      url: 'https://www.youtube.com/watch?v=EYaJ4kPYDGk',
    },
    {
      thumb: '/yt/vid2.jpg',
      url: 'https://www.youtube.com/watch?v=MK5j4u_nvIA',
    },
    {
      thumb: '/yt/vid3.jpg',
      url: 'https://www.youtube.com/watch?v=CJNxKptyBmw',
    },
    {
      thumb: '/yt/vid4.jpg',
      url: 'https://www.youtube.com/watch?v=CAaFeRiw5dQ',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center px-4" onContextMenu={(e) => e.preventDefault()}>
      ...
      <section className="w-full max-w-6xl space-y-24">
        ...
        {/* AS SEEN ON */}
{/* AS SEEN ON – VIDEO PROOF */}
<section className="w-full max-w-6xl mt-10">
  <p className="text-xs tracking-[0.35em] text-zinc-500 text-center mb-5">
    AS SEEN ON
  </p>

  <div className="overflow-x-auto snap-x snap-mandatory flex gap-4 px-2">
    {VIDEOS.map((v, i) => (
      <div
        key={i}
        className="snap-start shrink-0 w-[80%] sm:w-[320px] cursor-pointer"
