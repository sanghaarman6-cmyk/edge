...
<section className="w-full max-w-4xl text-center">
  <motion.h1
    ...
    className="text-[2.4rem] sm:text-[3.2rem] leading-[1.05] font-semibold"
  >
    Exploit a structural mismatch in prop firms
    <br />
    <span className="block mt-2 font-serif italic text-red-400">
  ...
  >
    ...
    This free training breaks down the exact system.
      ...
      <div ref={ctaRef} className="w-full max-w-5xl mt-16">
        <div
          className={`
      ...
      <section className="w-full max-w-5xl mt-16">
        ...
        <div className="bg-zinc-950 border border-zinc-800 rounded-2xl overflow-hidden mt-100">
          <img
...
<section className="w-full max-w-6xl mt-24 space-y-24">
  ...
  <div className="grid md:grid-cols-2 gap-12 items-start">
    ...
    {/* RIGHT FOCUS PANEL */}
    <div className="bg-gradient-to-b from-zinc-900/60 to-zinc-950 border border-zinc-800 rounded-3xl p-8">
