...
<section className="w-full max-w-6xl mt-24">
  ...
  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
    {[
      { name: 'Brandon', result: '$234K in 12 months', img: '/proofs/brandon.png' },
      { name: 'Jeff', result: '$188K under 12 months', img: '/proofs/jeff.png' },
      { name: 'Winston', result: '$54K month', img: '/proofs/winston.png' },
      { name: 'Diaz', result: '$52K in 8 days', img: '/proofs/diaz.png' },
      { name: 'Nico', result: '$50K month', img: '/proofs/nico.png' },
      { name: 'Isaac', result: '$44K day', img: '/proofs/isaac.png' },
      { name: 'Xavier', result: '$11K first week', img: '/proofs/xavier.png' },
      { name: 'Tiny', result: 'Broke → 5 figures', img: '/proofs/tiny.png' },
    ].map((item, i) => (
      <div
        key={i}
      ...
      >
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-green-400 text-sm">{item.result}</span>
        </div>
