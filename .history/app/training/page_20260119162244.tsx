...
<div className="my-6 sm:my-10 overflow-visible px-3 sm:px-0">
  <SystemFlow />
      ...
      <section className="w-full max-w-6xl space-y-24">
        ...
        {/* FAQ SECTION */}
<section className="w-full max-w-3xl mx-auto mt-24 mb-20 px-2">
    ...
    {[
      {
        ...
        a: 'You get immediate access to the full framework, system breakdowns, and the private community. Everything is structured step by step.',
      },
      {
        q: 'Is this for beginners or experienced traders?',
        a: 'This is best suited for traders who understand basic execution and want structure, not signals or guesswork.',
      },
      {
      ...
      },
      {
        ...
        a: 'Yes. The system is built so losing scenarios are planned and partially or fully monetised.',
      },
      {
  ...
  <div className="mt-12 text-center">
    <Button
      onClick={() => setOpen(true)}
      className="px-8 py-4 text-lg bg-blue-500 hover:bg-blue-400 text-white font-semibold rounded-2xl"
    >
    ...
    <p className="text-sm text-zinc-500 mt-3">
      Instant access • Cancel anytime
        ...
        <div className="grid md:grid-cols-2 gap-10 items-stretch">
          ...
          {/* WITHOUT SYSTEM */}
          <div className="relative bg-zinc-950 border border-red-500/20 rounded-3xl p-8">
          
            <h3 className="text-xl font-semibold text-white mb-2">
              Prop Firms Without a Hedge System
            </h3>

            <p className="text-sm text-red-400 mb-6">
              The default way most traders approach prop firms.
            </p>

            <ul className="space-y-4 text-sm text-zinc-300">
              <li className="flex gap-3">
                <span className="text-red-400">✕</span>
                One account, one direction, one outcome
              </li>
              <li className="flex gap-3">
                <span className="text-red-400">✕</span>
                Evaluation failure = total loss of fees
              </li>
              <li className="flex gap-3">
                <span className="text-red-400">✕</span>
                Drawdown measured on large virtual balances
              </li>
              <li className="flex gap-3">
                <span className="text-red-400">✕</span>
                Losing trades have no secondary monetisation
              </li>
              <li className="flex gap-3">
                <span className="text-red-400">✕</span>
                Profit depends entirely on win rate and prediction
              </li>
            </ul>
          </div>

          {/* WITH SYSTEM */}
          <div className="relative bg-zinc-950 border border-emerald-400/25 rounded-3xl p-8">
            <h3 className="text-xl font-semibold text-white mb-2">
              Prop Firms With the Hedge System
            </h3>

            <p className="text-sm text-emerald-400 mb-6">
              A structural approach built around asymmetric outcomes.
            </p>

            <ul className="space-y-4 text-sm text-zinc-300">
              <li className="flex gap-3">
                <span className="text-emerald-400">✓</span>
                Two accounts engineered for opposite outcomes
              </li>
              <li className="flex gap-3">
                <span className="text-emerald-400">✓</span>
                Evaluation failure is partially or fully monetised
              </li>
              <li className="flex gap-3">
                <span className="text-emerald-400">✓</span>
                Percentage-based prop losses offset with dollar profits
              </li>
              <li className="flex gap-3">
                <span className="text-emerald-400">✓</span>
                Losing scenarios are designed into the model
              </li>
              <li className="flex gap-3">
                <span className="text-emerald-400">✓</span>
                Profitability depends on structure, not prediction
              </li>
            </ul>
          </div>
        </div>
