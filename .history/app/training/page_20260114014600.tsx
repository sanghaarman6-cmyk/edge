...
<div className="mt-4 flex justify-center">
  <div className="px-4 py-2 rounded-full border border-red-400/40 bg-red-400/5">
    <span className="text-sm tracking-wide text-red-400">
      System: Two-account hedge architecture
    </span>
  </div>
</div>
