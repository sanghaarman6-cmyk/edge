...
export default function TrainingLandingPage() {
  ...
  className={`
    ...
    ${isFloating ? 'fixed bottom-4 left-1/2 -translate-x-1/2 z-40' : 'relative'}
  `}
>
  <div className="
    w-[92vw] max-w-5xl
  ...
  ">
    <div className="text-xs text-zinc-400 space-y-1">
      <div className="tracking-widest text-zinc-500">SYSTEM STATUS</div>
      <div>
        Framework: <span className="text-emerald-400">Loaded</span> ·
        Indicators: <span className="text-red-400">Disabled</span> ·
        Signals: <span className="text-red-400">Disabled</span>
      </div>
    </div>

    <Button
      onClick={() => setOpen(true)}
      className="px-6 py-3 bg-emerald-400 hover:bg-emerald-300 text-black font-semibold rounded-xl"
    >
      Unlock Framework
    </Button>
  </div>
