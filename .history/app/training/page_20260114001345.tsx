  ...
  return (
    ...
    >
      ...
      <section className="max-w-3xl w-full text-center">
        ...
        >
          ...
          <span className="text-red-400">
            {' '}
            Using a Two-Account Hedge System
          </span>
        </motion.h1>

        <p className="mt-4 text-zinc-400 text-base sm:text-lg">
          I built a prop-broker hedging system that generated over
          <span className="text-white font-semibold"> $750,000</span> using prop
          firms.
          <br />
      ...
      <section className="w-full max-w-6xl mt-24">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-zinc-400 text-lg mt-3">
            Join hundreds of operators applying the same framework.
          </p>
        </div>

        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { name: 'Brandon', result: '$234K in 12 months' },
            { name: 'Jeff', result: '$188K under 12 months' },
            { name: 'Winston', result: '$54K month' },
            { name: 'Diaz', result: '$52K in 8 days' },
            { name: 'Nico', result: '$50K month' },
            { name: 'Isaac', result: '$44K day' },
            { name: 'Xavier', result: '$11K first week' },
            { name: 'Tiny', result: 'Broke → 5 figures' },
          ].map((item, i) => (
            <div
              key={i}
            ...
            >
              ...
              <div className="h-44 w-full rounded-lg border border-zinc-800 bg-black flex items-center justify-center text-zinc-600 text-sm">
                Screenshot proof
              </div>
            </div>
          ))}
        ...
        <p className="text-xs text-zinc-500 text-center mt-8">
          Results vary by execution and risk tolerance. Proof shown from
          real users.
        </p>
      </section>
      {/* ============================================================ */}
      ...
      <footer className="text-xs text-zinc-600 my-8 text-center max-w-xl">
        Educational content only. Trading involves risk. Results are not
        guaranteed.
