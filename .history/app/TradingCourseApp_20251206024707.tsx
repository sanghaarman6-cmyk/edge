          ...
          >
            <div>
              ...
              <div className="flex flex-col space-y-1 mt-2 px-2">
                ...
                />
                {/* Telegram Buttons Inside Sidebar */}
                <div className="px-4 mt-6">
                  ...
                  <div className="flex flex-col gap-3 w-full">
                    ...
                    <a
                      ...
                      className="px-4 py-2 rounded-lg bg-zinc-700/80 hover:bg-zinc-600 
                      transition-all text-white text-sm font-semibold shadow-md 
                      hover:shadow-zinc-600/20 border border-zinc-500/20 text-center"
                    >
