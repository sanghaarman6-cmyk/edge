          ...
          >
            <div>
              ...
              <div className="flex flex-col gap-1 mt-2 px-3">
                ...
                <button
                  className={`${sidebarBtn} ${activeTab === 'home' ? 'bg-zinc-800 border-zinc-600' : ''}`}
                  onClick={() => {
                    setActiveTab("home");
                ...
                <button
                  className={`${sidebarBtn} ${activeTab === 'lessons' ? 'bg-zinc-800 border-zinc-600' : ''}`}
                  onClick={() => {
                ...
                <button
                  className={`${sidebarBtn} ${activeTab === 'documents' ? 'bg-zinc-800 border-zinc-600' : ''}`}
                  onClick={() => {
                ...
                <button
                  className={`${sidebarBtn} ${activeTab === 'calculator' ? 'bg-zinc-800 border-zinc-600' : ''}`}
                  onClick={() => {
                ...
                <button
                  className={`${sidebarBtn} ${activeTab === 'lot' ? 'bg-zinc-800 border-zinc-600' : ''}`}
                  onClick={() => {
                    setActiveTab("lot");
                    setSidebarOpen(false);
                  }}
              ...
              {/* COMMUNITY SECTION */}
              <div className="px-3 mt-99">
                
                            <div className="flex flex-col gap-2">

                  <a
                    href="https://t.me/YOUR_TESTIMONIAL_CHANNEL"
                    className={`${sidebarBtn} !justify-center`}
                  >
            ...
            <div className="flex flex-col items-center text-zinc-500 text-xs px-2">
              <p className="text-center text-zinc-600 mt-1">*Information For <br />Educational Purposes Only</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
