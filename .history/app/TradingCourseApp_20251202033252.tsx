        ...
        {activeTab === 'home' && (
          <div className="flex flex-col items-center justify-start w-full space-y-8 px-2 sm:px-0">
            ...
            <div className="relative w-full max-w-4xl px-2">
              ...
              <div className="relative w-full rounded-xl overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.6)]">
                <div className="w-full" style={{ paddingTop: "56.25%" }}></div> 
                {/* This creates a permanent 16:9 box BEFORE Wistia loads */}

                {/* Wistia Video positioned on top */}
