...
const ANNOUNCEMENT_STYLES = {
  neutral: {
    box: "border-zinc-700 bg-zinc-800/40",
    title: "text-zinc-200",
    text: "text-zinc-300",
  },
  green: {
...
export default function TradingCourseApp() {
  ...
  useEffect(() => {
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          console.log("🔥 ANNOUNCEMENT CHANGE:", payload.eventType, payload);
      ...
      .subscribe((status) => {
        console.log("📡 ANNOUNCEMENT REALTIME STATUS:", status);
      });
  ...
  const getNextIncompleteLessonId = () => {
  ...
  const handleCalculate = () => {
    ...
    const netIfFailAfter =
      fundedFailGrossPersonal - carryCost;
    ...
    // update carry cost for next cycle
  ...
  // ✅ Main Course App
  return (
    <div className="flex bg-black text-white font-sans pt-2">
      {/* FLOATING LOGO TOP-LEFT (no nav bar) */}
      ...
      <AnimatePresence>
        {sidebarOpen && (
          ...
          >
            <div>
              <div className="w-full flex flex-col items-center justify-center px-6 mb-6 mt-2">
              ...
              <div className="flex flex-col space-y-1 mt-2 px-2">
                <SidebarItem
                  ...
                  onClick={() => {
                    setActiveTab('home');
                    setSidebarOpen(false); // always close sidebar
                  }}
                />

                <SidebarItem
                  icon={<TvMinimalIcon size={20} />}
                  label="Lessons"
      ...
      {/* DARK OVERLAY (click outside closes sidebar) — FIXED: moved OUTSIDE AnimatePresence */}
      {sidebarOpen && (
        <div
          key="overlay"
      ...
      {!sidebarOpen && (
        <button
          ...
          className="absolute top-4 right-4 z-40 p-2 bg-zinc-900/80 rounded-lg border border-zinc-700 hover:bg-white/10 "
        >
      ...
      {/* Main Content */}
      <motion.div
        className="flex-1 px-4 py-6 pt-20 sm:p-8 overflow-y-auto h-full mt-2 sm:mt-6"
      >
        {activeTab === 'home' && (() => {
        const nextCTA =
          progress >= 100
          ...
          <div className="flex flex-col items-center justify-start w-full space-y-8 px-2 sm:px-0">
            ...
            <div className="text-center max-w-3xl">
              ...
              <p className="text-zinc-400 text-base sm:text-lg leading-relaxed">
                This method is engineered for <span className="text-red-400 font-semibold">mathematical certainty</span>, not luck.
                You are now inside <span className="text-red-400 font-semibold">Prop Accelerator</span> — follow the sequence precisely.
              </p>
            </div>

            <div className="w-full max-w-4xl bg-zinc-900/70 border border-zinc-700 rounded-2xl p-5">
              <p className="text-white text-sm font-semibold mb-1">Announcements</p>

              {announcementLoading ? (
                <p className="text-zinc-400 text-sm">Loading…</p>
              ) : announcementError ? (
                <p className="text-red-400 text-sm">
                  Failed to load announcements: {announcementError}
                </p>
                ...
                <div className="space-y-3">
                  {announcements.map((a) => {
                    ...
                    return (
                      <div
                        key={a.id}
                        className={`rounded-xl p-4 border ${styles.box}`}
                      >
                        {a.title && (
                ...
                <p className="text-zinc-400 text-sm">No active announcements.</p>
              )}
            </div>
            ...
            <div className="w-full max-w-4xl space-y-4">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="text-sm text-zinc-400 mt-2">
                      Mode: <span className="text-white font-semibold">Prop Accelerator (Hedged)</span>
                      <br />
                      Objective: <span className="text-white font-semibold">Funded → Payout Cycles</span>
                    </p>
                  </div>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5">
                  ...
                  <h4 className="text-base font-semibold">Watch Module 1</h4>
                  <p className="text-sm text-zinc-400 mt-2">
                    Start with foundations. No skipping.
                  </p>
                  <button
                    onClick={() => setActiveTab("lessons")}
                    className="mt-4 w-full px-4 py-2 rounded-xl bg-white/10 hover:bg-white/15 border border-white/10 text-sm font-semibold"
                  >
                    Go to Lessons
                  </button>
                </div>
                ...
                <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5">
                  ...
                  <h4 className="text-base font-semibold">Run Hedge Calculator</h4>
                  <p className="text-sm text-zinc-400 mt-2">
                    Generate your baseline hedge numbers.
                  </p>
                  <button
                ...
                <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5">
                  ...
                  <h4 className="text-base font-semibold">Size Your Lots</h4>
                  <p className="text-sm text-zinc-400 mt-2">
                    Convert theory → execution sizing.
                  </p>
                  <button
              ...
              {/* Non-negotiables */}
              <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 sm:p-6">
                <p className="text-xs text-zinc-500 mb-2">NON-NEGOTIABLES</p>
              ...
              <div className="flex justify-center pt-1">
                <button
                  ...
                  if (nextLessonId !== null) {
                    setActiveTab("lessons");
                    setTimeout(() => {
                      setActiveVideo(nextLessonId);
                    }, 200);
                  } else {
                    setActiveTab("calculator");
                  }
                }}
                  className="px-8 py-4 rounded-2xl bg-green-400 hover:bg-green-300 text-black font-bold text-lg shadow-[0_0_40px_rgba(74,222,128,0.25)]"
                >
                  {nextCTA}
                </button>
              </div>
          ...
          <div className="w-full">
            ...
            {activeVideo !== null && (
              <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                onClick={() => setActiveVideo(null)} // ← CLICK OUTSIDE CLOSES MODAL
              >
                <motion.div
...
function SidebarItem({
  ...
  const baseClasses =
    `flex items-center gap-3 px-3 py-2 w-full rounded-md 
     ...
     ${active ? "bg-zinc-800 text-white shadow-inner" : "text-zinc-400 hover:bg-zinc-800/60 hover:text-white"}
    `;
