...
export default function TradingCourseApp() {
  ...
  return (
    <div className="flex bg-black text-white font-sans pt-2">
      ...
      {/* Main Content */}
      <motion.div
        className="flex-1 px-4 py-6 pt-20 sm:p-8 overflow-y-visible h-full mt-2 sm:mt-6"
      >
        {/* 🏠 HOME */}
        {activeTab === 'home' && (
          <div className="flex flex-col items-center justify-start w-full space-y-8 px-2 sm:px-0">
            ...
            {/* 🎬 Sleek Intro Video */}
            <div className="relative w-full max-w-4xl px-2 overflow-visible">
              ...
              <div
                className="
                  pointer-events-none
                  absolute inset-6
                  bg-white/20         /* glow color */
                  blur-3xl              /* makes it soft & glowing */
                  rounded-3xl
                  z-0
                "
              />
        ...
        {activeTab === 'lessons' && (
          <div className="w-full">
            ...
            {/* Horizontal Scroll */}
            <div className="w-full overflow-hidden px-4 pt-2">
              <div
                ref={drag.ref}
                ...
                className="overflow-x-auto overflow-y-visible pb-4 hide-scroll cursor-grab active:cursor-grabbing select-none"
