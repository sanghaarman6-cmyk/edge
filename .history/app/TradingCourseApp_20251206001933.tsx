    ...
    <div className="flex h-screen bg-black text-white font-sans overflow-hidden">
      ...
      {!sidebarOpen && (
        <button
          ...
          className="fixed top-4 right-4 z-40 md:hidden p-2 bg-zinc-900/80 rounded-lg border border-zinc-700"
        >
          <svg width="22" height="22" fill="white">
            <path d="M3 6h16M3 12h16M3 18h16" stroke="white" strokeWidth="2" strokeLinecap="round" />
          </svg>
        </button>
      )}
