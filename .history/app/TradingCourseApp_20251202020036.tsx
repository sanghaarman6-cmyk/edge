...
export default function TradingCourseApp() {
  ...
  const categories: Category[] = [
  {
    ...
    lessons: [
      { title: 'The Prop Firm Game — How the System Really Works', duration: '5:00', video: 'pqpsbw2gh3', thumbnail: "/thumbnails/t1.png" },
      { title: 'The One-Trade Evaluation Pass Method', duration: '5:00', video: 'pqpsbw2gh3', thumbnail: "/thumbnails/t2.png" },
      { title: 'The Funded Account Hedge System (Payout Engine)', duration: '5:00', video: 'pqpsbw2gh3', thumbnail: "/thumbnails/t3.png" },
      { title: 'The Hedge Engine — Lot Sizes, Copier Setup & Margin Control', duration: '5:30', video: 'pqpsbw2gh3', thumbnail: "/thumbnails/t4.png" },
      { title: 'The Ghost Protocol Playbook — Scaling, Ban Avoidance & Mastery', duration: '5:30', video: 'pqpsbw2gh3', thumbnail: "/thumbnails/t5.png" },
      ...
      >
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center gap-4">
          ...
          <a
            ...
            className="w-full sm:w-auto px-5 py-3 rounded-lg bg-blue-600 hover:bg-blue-500 transition text-white font-semibold text-center shadow-lg"
          >
            ⭐ Join Testimonials Channel
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-full sm:w-auto px-5 py-3 rounded-lg bg-green-600 hover:bg-green-500 transition text-white font-semibold text-center shadow-lg"
          >
            💬 Join Free Student Group Chat
          </a>
