...
export default function TradingCourseApp() {
  ...
  const pageBg = "min-h-screen w-full bg-black"
  ...
  const chipActive = "border-white/20 bg-white/10 text-white"
  const chipIdle = "border-zinc-800/70 bg-zinc-950/40 text-zinc-300 hover:bg-white/5 hover:text-white"
        ...
        <div className={`pointer-events-auto mx-auto max-w-6xl rounded-3xl ${glass}`}>
                ...
                {TABS.map((t) => (
                  <button
                    ...
                    className={[
                      ...
                      activeTab === t.key ? "bg-white text-black shadow-[0_10px_30px_rgba(0,0,0,0.45)]" : "text-zinc-300 hover:bg-white/10 hover:text-white",
                    ].join(" ")}
                    title={t.label}
                  >
                    <span className={activeTab === t.key ? "text-black" : "text-zinc-300 group-hover:text-white"}>{t.icon}</span>
          ...
          <div className="flex items-center justify-between gap-3 border-t border-zinc-800/70 px-4 py-3 sm:px-5">
            ...
            <div className="flex min-w-[140px] items-center gap-3">
              ...
              <div className="w-12 text-right text-xs font-semibold text-zinc-200">{progress}%</div>
            </div>
          </div>
        </div>
      </div>
                        ...
                        >
                          <div className="relative h-[70%] w-full overflow-hidden">
                            <img
                              ...
                              alt={lesson.title}
                            />
                            <div className="absolute inset-0 bg-linear-to-b from-black/10 via-black/35 to-black/85" />
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                          ...
                          <div className="flex flex-wrap gap-2">
                            <button
                              ...
                              className={`rounded-2xl border px-3 py-2 text-xs font-semibold transition ${active ? "border-white/20 bg-white text-black" : "border-zinc-800/70 bg-zinc-950/40 text-zinc-200 hover:bg-white/10"}`}
                            >
            ...
            <div className="mx-auto max-w-4xl space-y-6">
              <div className={`rounded-[28px] ${glass} p-6`}>
                ...
                <p className="mt-2 text-sm text-zinc-400">
                  Same logic, cleaner cockpit. Educational use only — not financial advice.
                </p>
              </div>
                ...
                <Card className={`${glass}`}>
                  <CardContent className="space-y-5 p-5">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3">
                      ...
                      <div className={`flex items-center gap-1 rounded-2xl ${hairline} ${soft} p-1`}>
                        <button
                          ...
                          className={`rounded-2xl border px-4 py-2 text-sm font-semibold transition ${evalType === "one-step" ? "border-white/20 bg-white text-black" : "border-transparent text-zinc-200 hover:bg-white/10"}`}
                        >
                          1-step
                        </button>
                        <button
                          onClick={() => setEvalType("two-step")}
                          className={`rounded-2xl border px-4 py-2 text-sm font-semibold transition ${evalType === "two-step" ? "border-white/20 bg-white text-black" : "border-transparent text-zinc-200 hover:bg-white/10"}`}
                        >
                          2-step
                        </button>
                      </div>
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      ...
                      <Field
                        label="Risk per day on prop (evaluation) %"
                        hint="Must be ≤ Daily DD. Total risk per day during evaluation."
                      >
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      <button
                        ...
                        className="rounded-2xl bg-white px-5 py-3 text-sm font-semibold text-black hover:bg-zinc-100"
                      >
                        Calculate
                      </button>

                      <div className="text-xs text-zinc-500">
                        Tip: keep inputs identical across calculator + lot tool for consistent sizing.
                      </div>
                    </div>
                  </CardContent>
                </Card>
                    ...
                    <CardContent className="space-y-4 p-5 text-sm leading-relaxed">
                      ...
                      <div className={`rounded-[22px] border border-zinc-800/70 bg-zinc-950/40 p-4`}>
                        ...
                        <div className="mt-3 space-y-2 text-zinc-300">
                          <p>
                            Risk per trade (eval):{" "}
                            <span className="font-semibold text-zinc-100">{calcResult.riskPerTradeEval.toFixed(2)}%</span>{" "}
                            with{" "}
                            <span className="font-semibold text-zinc-100">{calcResult.tradesPerDayEval}</span>{" "}
                            trade(s)/day.
                          </p>
                          <p>
                            Max SL trades before max DD:{" "}
                            <span className="font-semibold text-zinc-100">{calcResult.maxEvalSLTrades}</span>
                          </p>
                          <div className="mt-2 space-y-1">{renderDayByDay(calcResult.maxEvalSLTrades, calcResult.tradesPerDayEval, calcResult.perSLProfitEval, "evaluation hedge")}</div>
                      ...
                      <div className={`rounded-[22px] border border-zinc-800/70 bg-zinc-950/40 p-4`}>
                        ...
                        <div className="mt-3 space-y-2 text-zinc-300">
                          <p>
                            Phase 1 target:{" "}
                            <span className="font-semibold text-zinc-100">{calcResult.phase1Target.toFixed(2)}%</span>{" "}
                          ...
                          {calcResult.evalType === "two-step" && calcResult.phase2RR !== undefined && (
                            <p>
                              Phase 2 target:{" "}
                              <span className="font-semibold text-zinc-100">{calcResult.phase2Target?.toFixed(2)}%</span>{" "}
                      ...
                      <div className={`rounded-[22px] border border-zinc-800/70 bg-zinc-950/40 p-4`}>
                        ...
                        <div className="mt-3 space-y-2 text-zinc-300">
                          <p>
                            ...
                            <span className="font-semibold text-zinc-100">{calcResult.riskPerTradeFunded.toFixed(2)}%</span>{" "}
                            with{" "}
                            <span className="font-semibold text-zinc-100">{calcResult.fundedTradesPerDay}</span>{" "}
                            trade(s)/day.
                          </p>
                          <p>
                          ...
                          <p>
                            Max SL trades before max DD:{" "}
                            <span className="font-semibold text-zinc-100">{calcResult.maxFundedSLTrades}</span>
                          </p>
                          <div className="mt-2 space-y-1">{renderDayByDay(calcResult.maxFundedSLTrades, calcResult.fundedTradesPerDay, calcResult.perSLProfitFunded, "funded hedge")}</div>
                          <div className="mt-3 border-t border-zinc-800/70 pt-3">
                            <p>
                      ...
                      <div className={`rounded-[22px] border border-zinc-800/70 bg-zinc-950/40 p-4`}>
                        ...
                        <div className="mt-3 space-y-2 text-zinc-300">
                          <div className="grid gap-3 sm:grid-cols-3">
                            <MiniStat
                              label="Payout amount"
                              value={`$${Math.round(calcResult.payoutAmount).toLocaleString()}`}
                              emphasize
                            />
                            <MiniStat
                              label="Hedge loss per payout"
                              value={`$${Math.round(calcResult.hedgeLossPerPayout).toLocaleString()}`}
                            />
          ...
          {activeTab === "lot" && (
            <div className="mx-auto max-w-4xl space-y-6">
              <div className={`rounded-[28px] ${glass} p-6`}>
                ...
                <p className="mt-2 text-sm text-zinc-400">
                  Approx lot sizing + margin estimate. Educational use only — verify with your broker.
                </p>
              </div>
                ...
                <Card className={`${glass}`}>
                  <CardContent className="space-y-4 p-5">
                    ...
                    <button
                      ...
                      className="mt-2 rounded-2xl bg-white px-5 py-3 text-sm font-semibold text-black hover:bg-zinc-100"
                    >
                      Calculate lot sizes
                    </button>
                  </CardContent>
                    ...
                    <CardContent className="space-y-4 p-5 text-sm leading-relaxed">
                      ...
                      <div className="grid gap-3 md:grid-cols-2">
                          ...
                          <div className="mt-3 space-y-2 text-zinc-300">
                            ...
                            {typeof lotResult.approxMarginUsedPercent === "number" && (
                              <p className="text-xs text-zinc-500">
                                Approx margin usage:{" "}
                                <span className="font-semibold text-zinc-200">{lotResult.approxMarginUsedPercent.toFixed(1)}%</span>
                              </p>
                            )}
                          </div>
                        </div>
                        ...
                        <div className="rounded-[22px] border border-zinc-800/70 bg-zinc-950/40 p-4">
                          ...
                          <div className="mt-3 space-y-2 text-zinc-300">
                            <p>
                              Target per 1% prop loss:{" "}
                              <span className="font-semibold text-zinc-100">${lotResult.hedgePerPercent.toFixed(2)}</span>
                            </p>
                            <p>
...
function MiniStat({ label, value, emphasize }: { label: string; value: string; emphasize?: boolean }) {
  return (
    <div className={`rounded-2xl border border-zinc-800/70 bg-zinc-950/35 p-3 ${emphasize ? "shadow-[0_18px_60px_rgba(0,0,0,0.55)]" : ""}`}>
...
function QuickTile({
  ...
  return (
    <button
      onClick={onClick}
      className="group w-full rounded-3xl border border-zinc-800/70 bg-zinc-950/45 p-4 text-left shadow-[0_18px_70px_rgba(0,0,0,0.55)] transition hover:bg-white/5"
    >
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <div className="mt-2 space-y-1">
            {trades.map((t) => (
              <p key={t.trade} className="text-sm text-zinc-300">
                Trade {t.trade} SL ={" "}
                <span className="font-semibold text-zinc-100">${Math.round(t.profit).toLocaleString()}</span>{" "}
                on personal ({label})
              </p>
            ))}
          </div>
