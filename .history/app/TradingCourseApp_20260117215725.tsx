...
===================================================================================== */
  ...
  return (
    <div className={`w-full ${theme.appBg}`}>
      <style jsx global>{`
        .pa-input {
          width: 100%;
      ...
      <div className="flex min-h-screen">
        ...
        <div className="flex flex-1 flex-col">
          ...
          <main className="flex-1 px-6 py-6 pl-0 md:pl-[120px]">
...
function TopBar({
  ...
  return (
    ...
    >
      ...
      <div className="px-5 pt-4 pl-0 md:px-7 md:pl-[120px]">
