        ...
        {activeTab === 'home' && (
          <div className="flex flex-col items-center justify-start w-full space-y-8">
            ...
            <div className="relative w-full max-w-4xl">
               <div className="absolute inset-0 -z-10 blur-3xl opacity-40 bg-blue-600 rounded-3xl"></div>

               <div className="rounded-xl overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.6)]"></div>
