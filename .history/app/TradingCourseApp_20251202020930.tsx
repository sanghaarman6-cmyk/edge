        ...
        <div className="flex flex-col items-center justify-start w-full space-y-8">
          ...
          <div className="mt-10 flex flex-col items-center justify-center w-full">
            <p className="text-zinc-400 text-sm mb-4 text-center">
              Plug into the network — stay updated, stay ahead.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
              ...
              <a
                ...
                className="px-6 py-3 rounded-xl bg-blue-600/90 hover:bg-blue-500 
                transition-all text-white text-sm font-semibold shadow-md 
                hover:shadow-blue-600/30 border border-blue-400/30 
              ...
              <a
                ...
                className="px-6 py-3 rounded-xl bg-green-600/90 hover:bg-green-500 
                transition-all text-white text-sm font-semibold shadow-md 
                hover:shadow-green-600/30 border border-green-400/30 
                w-full sm:w-auto text-center"
              >
                💬 Student Group Chat
              </a>
